...
<head>
    ...
    <title>Edit Article|Spydercode</title>
    ...
    <!--CSS -->
    <link rel="stylesheet" href="{{ asset('css/writty.css') }}">
...
<body>
    ...
    <form action="{{ route('article.update',['article'=>$article->id]) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <input type="hidden" name="content" id="article_content" value="{{ $article->content }}">
        <div class="container">
            <div class="topbar">
                    ...
                    <div class="input-group">
                        ...
                        <select name="category_id" class="input">
                            ...
                            @foreach ($category as $item)
                                <option {{ $article->category_id==$item->id?'selected':'' }} value="{{ $item->id }}">{{ $item->nama }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="input-group">
    ...
    <!-- Writty JS -->
    <script src="{{ asset('js/writty.js') }}"></script>

    <!-- Autosave -->
    <script src="{{ asset('js/writtyautosave.js') }}"></script>
    <script>
